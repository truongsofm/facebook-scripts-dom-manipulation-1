...
let timeWaitAreYouSureDialogShow = 1500; // Time to wait Are you sure? dialog show when click Leave group button/ Thời gian chờ load xong bảng xác nhận rời nhóm khi bấm vào nút Rời nhóm
let timeWaitLeaveGroupSuccessfully = 3800; // Time to wait left group successfully/ Thời gian chờ để rời hẳn nhóm
